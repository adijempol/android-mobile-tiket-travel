...
import com.latihan.project1.model.HistoryModel;
import com.latihan.project1.adapter.HistoryAdapter;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    String id_book = "", asal, tujuan, tanggal, anggota, riwayat, total;
    String email;
    TextView tvNotFound;
...
//                    "Jumlah pembelian tiket dewasa sejumlah " + anggota + ".";
...
//        }
        ...
        //            anak = cursor.getString(5);
                    ...
                    riwayat = "Berhasil melakukan booking untuk melakukan perjalanan dari " + asal + " menuju " + tujuan + " pada tanggal " + tanggal + ". " +
                            "Jumlah pembelian sejumlah " + anggota + ".";
                    hasil.add(new HistoryModel(id_book, tanggal, riwayat, total, R.drawable.profile));
