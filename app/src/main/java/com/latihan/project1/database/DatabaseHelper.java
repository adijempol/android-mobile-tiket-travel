package com.latihan.project1.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "db_trip";
    ...
    public static final String COL_ANGGOTA = "anggota";
...
//    public static final String COL_HARGA_ANAK = "harga_anak";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_BOOK + " (" + COL_ID_BOOK + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                COL_ASAL + " TEXT, " + COL_TUJUAN + " TEXT" + ", " + COL_TANGGAL + " TEXT, " + COL_ANGGOTA + " TEXT)");
